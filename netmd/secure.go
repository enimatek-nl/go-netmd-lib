...
// this will put the netmd into 'rec' mode and reads from the bulk in until the total bytes was reached
// it will process the data based on the wire and disc format
